...
#SBATCH --job-name="jobname"		# Name of the job for checking
#SBATCH --time=04:30:00			# Wall clock time requested
#SBATCH --partition=<partition>		# Which partition?
#SBATCH --account=<name of account>	# Account to charge
#SBATCH --tasks=64			# Number of tasks
#SBATCH --cpus-per-task=1		# Number of cpu per task
#SBATCH --mem=100G			# Get all the memory
